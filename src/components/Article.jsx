...
const Article = ({ img, title, date, link }) => {
  return (
    ...
    dark:bg-dark dark:text-light dark:border dark:border-solid dark:border-light 
    dark:border-r-4 dark:border-b-4 sc-sm:flex-col"
    >
      <MovingImg title={title} img={img} link={link} />
      <span className="text-auxiliarPurple dark:text-secondary font-medium pl-4 sc-sm:self-start sc-sm:pl-0">{date}</span>
    </motion.li>
  );
};
